                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li style="color: #0073a4">2. Review</li>
                ...
                <div class="container">
                    <div class="row" style="text-align: left;">
                        ...
                        <div class="col-lg-4 well">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="text-left" for="id">ID Pesanan</h3>
                                </div>
                                <div class="col-sm-6">
                                    <h3 class="text-right" id="id"><%=id%></h3>
                                </div>
                            </div><br>
                            <div class="row well">
                                <h3 for="jamPinjam">Lanjut ke Pembayaran</h3><br>
                                <p id="jamPinjam">Dengan mengeklik tombol di bawah, Anda menyetujui Syarat & Ketentuan dan Kebijakan Privasi 4 Sekawan.</p>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-warning btn-lg btn-block" id="booking">
                                        <a href="transaksi.jsp" style="text-decoration: none; color: white;">Lanjutkan</a>
                                    </button>
                                </div>
                            </div>
                        </div>
