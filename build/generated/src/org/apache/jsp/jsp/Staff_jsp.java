...
Kontrol_Supir k = new Kontrol_Supir();
      ...
      out.write("\n");
      out.write("<!--                        <form action=\"../ServletHapusSupir\">\n");
      out.write("                            <button class=\"btn btn-danger btn-sm\" type=\"submit\" name=\"hapus\" value=\"");
      out.print(supirList.get(i).getIdSupir());
      out.write("\" data-toggle=\"tooltip\" title=\"Hapus Supir\">\n");
