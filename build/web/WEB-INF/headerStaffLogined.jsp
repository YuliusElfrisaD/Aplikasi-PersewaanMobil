            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle">INPUT<b class="caret"></b></a>
                            <ul class="dropdown-menu" id="menu1">
                                <li><a href="../jsp/InputSupir.jsp">Input Supir</a></li>
                                <li><a href="#">Input Mobil</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle">VIEW<b class="caret"></b></a>
                            <ul class="dropdown-menu" id="menu1">
                                <li><a href="../jsp/Supir.jsp">View Supir</a></li>
                                <li><a href="../jsp/Mobil.jsp">View Mobil</a></li>
                                <li><a href="../jsp/Persewaan.jsp">View Persewaan</a></li>
                            </ul>
                        </li>
                        <%
