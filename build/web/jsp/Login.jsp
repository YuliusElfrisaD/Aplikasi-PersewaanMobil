<%-- 
    Document   : Login
    Created on : Oct 25, 2017, 2:25:25 PM
    Author     : Asus a455l
--%>
...
<html>
    <head>
        ...
        <!--<link rel="stylesheet" href="../Bahan/cssku/loginstyle.css">-->
    </head>
    <body>
        <header>    
        ...
        <div class="container">
            ...
            <div class="col-md-6">
                <div class="row myborder">
                    <h4 style="color: #3766ab; margin: initial; margin-bottom: 10px;">Login</h4><hr>
                    <form method="POST" action= "../Login">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button class="btn-u pull-left btn-primary" type="submit">Masuk</button>
                            </div>
                        </div>
                    </form>
                    <%try {
                            ...
                            <br><h5 style="color: #cc0000; margin: initial; margin-bottom: 10px;">Anda belum berhasil login</h5>
                    <% } else if (request.getParameter("error").equals("y")) {%>
                            <h5 style="color: #cc0000; margin: initial; margin-bottom: 10px;">Username dan password anda salah</h5>
                    <%}%>
                    <% } catch (Exception ex) {
        ...
        <!--                <div class="loginBox">
                            <img src="../Bahan/Gambar/icon user 2.png" class="user">
                            <h2>Log In Here</h2>
